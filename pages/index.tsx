...
export default function HomePage() {
  return (
    <>
      <PageHeader eyebrow="Bem-vindo" title="Sistema de Paginas SENAI" description="Projeto colaborativo desenvolvido durante a prova pratica de versionamento. Use o menu acima para navegar entre as paginas."/>
